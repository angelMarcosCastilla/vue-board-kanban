...
<template>
  <div class="flex justify-center gap-5 py-3 rounded-md w-10/12 m-auto bg-slate-300 dark:bg-slate-800">
    ...
    <label for="checked-toggle" class="inline-flex relative items-center cursor-pointer">
      <input type="checkbox" @change="changeTheme" id="checked-toggle" class="sr-only peer" :checked="theme==='light'">
      <div
        class="w-11 h-5 bg-violet-600 rounded-full peer-checked:after:translate-x-6 peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all  ">
      </div>
    </label>
    <div>
      <svg width="19" height="19" xmlns="http://www.w3.org/2000/svg" class="text-slate-500">
        <path
